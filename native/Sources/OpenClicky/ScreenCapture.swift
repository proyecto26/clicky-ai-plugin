...
//  Keeps ":screen1" (the default when Claude omits the suffix)
//  semantically equal to "the screen the user is looking at".
//
...
struct ScreenCapture {
    ...
    /// Captures every connected display. Excludes OpenClicky's own windows
