...
//
//  File: ~/Library/Application Support/OpenClicky/last-session.json
...
struct SessionPersistence {
    ...
    private let logger = Logger(subsystem: "com.proyecto26.openclicky", category: "SessionPersistence")
